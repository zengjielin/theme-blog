import{_ as e,o as i,c as n,b as d}from"./app-C1UKEBg0.js";const a={},r=d(`<h1 id="常用递归" tabindex="-1"><a class="header-anchor" href="#常用递归" aria-hidden="true">#</a> 常用递归</h1><h5 id="向上递归获取部门-id-路径" tabindex="-1"><a class="header-anchor" href="#向上递归获取部门-id-路径" aria-hidden="true">#</a> 向上递归获取部门 id 路径</h5><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const originData: any[] = treeData // 接口返回的部门树数据
