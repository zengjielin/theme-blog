import{_ as l,p as s,q as a,s as e,R as t,t as n,Z as d,n as r}from"./framework-053dfde5.js";const v={},c=e("h1",{id:"大屏窗口自适应方案",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#大屏窗口自适应方案","aria-hidden":"true"},"#"),t(" 大屏窗口自适应方案")],-1),u={id:"v-scale-screen",tabindex:"-1"},o=e("a",{class:"header-anchor",href:"#v-scale-screen","aria-hidden":"true"},"#",-1),m={href:"https://github.com/zhangqh22/v-scale-screen",target:"_blank",rel:"noopener noreferrer"},g=d(`<blockquote><p>大屏自适应容器组件，可用于大屏项目开发，实现屏幕自适应，可根据宽、高、宽高比进行自适应，实现全屏自适应。</p><p>在 2.2.0+版本中，我们同时支持 vue&gt;=v3 或者 &lt;=2.7，如果您的项目是 v2.6 版本以下，则使用 1.x 版本。</p></blockquote><ul><li><p>安装：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install v-scale-screen
